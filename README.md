...
* wxWidgets >= 3.0
  * Linux: `sudo apt-get install libwxgtk3.0-dev libwxgtk3.0-0v5`. If you are facing unmet dependency issues, refer to the [official page](https://wiki.codelite.org/pmwiki.php/Main/WxWidgets30Binaries#toc2)
  for installing the unmet dependencies.
    * Look for available packages with : `sudo apt-cache search libwxgt*`
    * For Ubuntu 20.04.2 LTS : `sudo apt-get install libwxgtk3.0-gtk3-0v5 libwxgtk3.0-gtk3-dev`
